...
@Component({
  ...
  imports: [MatFormFieldModule, FormsModule, MatInputModule, MatSlideToggleModule, MatSelectModule, MatDatepickerModule, Loading, MatButtonModule],
  templateUrl: './create-training.html',
  styleUrl: './create-training.scss',
})
