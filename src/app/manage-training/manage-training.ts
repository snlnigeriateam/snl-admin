...
import { Training, TrainingAsset, TestQuestion, TrainingContent, QuestionOption, Role } from '../interfaces';
...
@Component({
	...
	imports: [MatIconModule, MatFormFieldModule, FormsModule, MatInputModule, MatSelectModule, MatRadioModule, MatDatepickerModule, Loading, MatButtonModule, MatSlideToggleModule],
