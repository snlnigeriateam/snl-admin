...
import { UserTraining, TrainingAsset, TrainingContent, UserTestQuestion, TrainingActivity } from '../interfaces';
...
@Component({
	...
	imports: [MatIconModule, MatFormFieldModule, FormsModule, MatInputModule, MatRadioModule, DatePipe, Loading, MatButtonModule],
	templateUrl: './take-training.html',
	styleUrl: './take-training.scss',
})
export class TakeTraining {
	t_id: string;
