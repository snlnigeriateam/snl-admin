...
import { User, UserTraining, Property, Training, Position, Role } from '../interfaces';
...
@Component({
	...
	imports: [DatePipe, MatIconModule, MatExpansionModule, MatFormFieldModule, FormsModule, MatInputModule, MatRadioModule, MatSelectModule, MatDatepickerModule, Loading, MatButtonModule],
	templateUrl: './manage-direct-report.html',
	styleUrl: './manage-direct-report.scss',
})
export class ManageDirectReport {
